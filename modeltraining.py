...
vggish_model = load_model('path_to_pretrained_vggish_model.h5')

# Load your sound pattern recognition model (e.g., a CNN for classification)
sound_pattern_model = load_model('path_to_pretrained_sound_pattern_model.h5')
...
audio_file_path = 'C:\Users\ariun\Downloads\davinci dataset\Ambulance_final\ambulance142.wav'
